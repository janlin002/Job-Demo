...
import { selectTodo, addTodo } from "../../slice/todo";
import {
  useGetTodoQuery,
  useAddTodoMutation,
  todoApiSlice,
...
const ReduxToolkitTest = () => {
  ...
  // console.log(
  //   todoApiSlice.endpoints.getTodo.useQueryState().data,
  //   "todoApiSlice"
  // );
  ...
  const handleChangeRedux = () => {
    dispatch(addTodo({ id: 3, name: "a new todo item" }));
  };
  ...
  return (
    <ul>
      <button type="button" onClick={handleChangeRedux}>
        點擊更改
      </button>
