...
import ExportsButtons from 'Components/exports'
import { LoadingPrompt } from 'Components/loading'
import { ApiErrorMessagePage, NoDataPage } from 'Components/formPage'

import IntlMessages from 'Util/IntlMessages'

const COMMON_BUTTON_ID = 'form.common.button'
const COMMON_PLACEHOLDER_ID = 'form.common.placeholder'
...
const formatedSearchData = (columns, data) => {
  const columnKeys = columns.reduce((previousValue, currentValue) => (
    {
      ...previousValue,
  ...
  const formatedData = data.map((item) => ({ ...columnKeys, ...item }))
  return formatedData
}
...
CustomTable.propTypes = {
  ...
  exports: PropTypes.instanceOf(Array),
  exportsFormat: PropTypes.instanceOf(Object),
  sort: PropTypes.bool,
